...
const CONTACT_CARDS = [
  { icon: <FaEnvelope />, label: 'Email Support', value: 'support@ctransit.me' }, 
  { icon: <FaWhatsapp />, label: 'WhatsApp Support', value: '+234 9045 955 670' }, 
  { icon: <FaPhone />, label: 'Phone Support', value: '09045955670' },
