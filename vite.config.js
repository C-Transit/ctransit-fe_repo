...
const TARGET_ENTRIES = {
  ...
  driver: {
    name: "driver",
    main: path.resolve(__dirname, "src/apps/driver/main.jsx"),
    app: path.resolve(__dirname, "src/apps/driver/App.jsx"),
    htmlScript: "/src/apps/driver/main.jsx",
    title: "C-Transit Driver Portal",
  },
};
...
export default defineConfig(({ mode }) => {
  ...
  const appTarget = ["admin", "agent", "driver", "web"].includes(rawTarget) ? rawTarget : "web";
